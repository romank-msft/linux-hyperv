...
struct vmbus_channel_version_response {
	...
	u32 msg_conn_id;
	/*
	 * Available from the VMBus protocol version 6.0. Adding this field
	 * doesn't change sizes of the union's this struct participates in,
	 * but there are sizeof() of this struct risking corruption, etc.
	 * Reading this fieldis undefined for the older protocol versions.
	 * TODO: Deferring adding it to the next pass.
	 */
